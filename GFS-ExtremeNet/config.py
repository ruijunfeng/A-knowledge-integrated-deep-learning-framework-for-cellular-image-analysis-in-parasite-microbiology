...
class Config:
    def __init__(self):
        ...
        # Training Config
        self._configs["display_interval"]  = 5
        self._configs["snapshot_interval"] = 50
        
        self._configs["stepsize"]          = 450
        self._configs["learning_rate"]     = 0.025
        ...
        self._configs["chunk_sizes"]       = [1]

        # Directories
        self._configs["data_dir"]   = "./dataset"
        self._configs["cache_dir"]  = "./checkpoints"
    ...
    def result_dir(self):
        ...
        result_dir = os.path.join(self._configs["result_dir"])
    ...
    def snapshot_interval(self):
        return self._configs["snapshot_interval"]

    @property
    def display_interval(self):
        return self._configs["display_interval"]
    ...
    def update_config(self, new):
        ...
        self.snapshot_dir = os.path.join(self.cache_dir, datetime.now().strftime('%Y%m%d-%H%M%S'))
